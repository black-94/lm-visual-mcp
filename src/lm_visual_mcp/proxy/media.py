...
end up as a local temp file so the existing providers can read them. Reuses
:class:`MediaService` for remote downloads / validation.
"""
...
from ..services.media import MediaService, tempfile_mkdtemp
