...
only receive the final :class:`VisionRequest`. Every prompt ends with the shared
structured-output rules so the model produces the unified JSON schema.
"""
...
_TOOL_PROMPTS = {
    ...
    "analyze_video": video_analysis.SYSTEM_PROMPT,
    "video_analysis": video_analysis.SYSTEM_PROMPT,
}
